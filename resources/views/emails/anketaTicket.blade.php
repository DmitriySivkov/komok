    ...
    <style type="text/css">
        ...
        */
        ...
        .button {
            ...
            -webkit-transition: background 0.4s linear, color 0.25s ease-out;
            transition: background 0.4s linear, color 0.25s ease-out;
            font-family: inherit;
            ...
            background: -webkit-gradient(linear, left top, right top, color-stop(.66%, #FFC01E), color-stop(9.01%, #FFBB1B), color-stop(67.61%, #FF9C07), color-stop(100.3%, #FF9000));
            background: linear-gradient(
                90deg, #FFC01E .66%, #FFBB1B 9.01%, #FF9C07 67.61%, #FF9000 100.3%);
        }
        /* MOBILE STYLES */
                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td align="center" valign="top" class="textContent">
                                                                <h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Спасибо за заявку!</h1>
                                                                <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">"Забронируйте путевку в лагерь"</h2>
                                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">Сообщение сгенерировано автоматически</div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" style="max-width: 100%;">
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:center;">Пожалуйста, проверьте данные и заполните анкету</h3>
