...
@section('body')
    ...
    <div class="place">
        <img class="place__circle" src="{{ asset('images/place/circle-2.png') }}">
        <div class="grid-container">
    ...
    <div class="grid-container">
        <div class="map"><img class="map__circle" src="{{ asset('images/place/circle-4.png') }}">
    ...
    <div class="bus">
        <img class="bus__image" src="{{ asset('images/place/bus.png') }}">
        <div class="grid-container">
            <div class="grid-x">
